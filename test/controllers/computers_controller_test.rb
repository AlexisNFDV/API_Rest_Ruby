...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { name: @computer.name, processor: @computer.processor, ram: @computer.ram, size: @computer.size, storage: @computer.storage } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { name: @computer.name, processor: @computer.processor, ram: @computer.ram, size: @computer.size, storage: @computer.storage } }
